...
PARAM_BOUNDS = {
    ...
    "d1": (0.5,    8.0),
    "d2": (0.5,    5.0),
    "h":  (0.0,   10.0),   # dataset has h in [0.0, 5.25]
    "p":  (2.0,  400.0),   # dataset has p in [3, 350.5]
}
...
AUG_OVERSAMPLE_FACTOR = 3      # generate 3x target, filter down
AUG_RANDOM_SEED = 42

# -----------------------------------------------------------------------------
# LHS unlabelled pool for active learning
# -----------------------------------------------------------------------------
LHS_N_CANDIDATES = 2000   # generate 2000, ~11% pass ordering -> ~220 valid
LHS_RANDOM_SEED = 42
